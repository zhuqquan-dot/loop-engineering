...
This Code of Conduct applies within all community spaces, including the repository, issues, pull requests, discussions, and any other spaces where the project is represented.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers through GitHub's private security advisory channel or by opening a confidential issue with a maintainer.
